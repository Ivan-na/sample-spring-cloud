...
public class CityController extends CommonController<CityController> {
    ...
    public static void main(String[] args) {
        ...
        BizCommonEntity<CityAirport> bizEntity = BizCommonEntity.fromJsonWithLowerCase(jsonResult, CityAirport.class);
        CityAirport aaa = bizEntity.getData();

        System.out.println(aaa.getCities().get(0).toString());
    }
